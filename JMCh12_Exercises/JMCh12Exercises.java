...
public class JMCh12Exercises {
    ...
    public char getRandomRps() {
        ...
        return array[(int) (Math.random() * 14)];
    }
    ...
    public String whatDoesMysteryCountCount() {
        ...
        int count = mysteryCount(v);

        String answer = count + " is the number of 0's at the front of the array";
    ...
    public static int computeScore(String word) {
        ...
        for (int i = 0; i < word.length(); i++) {
            if (isAlphabetic(word.charAt(i))) {
                int letterIdx = alphabet.indexOf(word.charAt(i));
                sum += letterScores[letterIdx];
            } else {
                i++;
            }
    ...
    public static double averageTopTwo(int[] scores) {
        ...
        if (scores[iMax2] > scores[iMax1]) {
            i = iMax1;
            scores[iMax1] = scores[iMax2];
            scores[iMax2] = scores[i];

        }
        for (i = 2; i < size; i++) {
            if (scores[i] > scores[iMax1]) {
                scores[iMax2] = scores[iMax1];
                scores[iMax1] = scores[i];
    ...
    public static boolean covers(double[][] m1, double[][] m2) {
        int counterMoreThan = 0, counterLessThan = 0;
        ...
        return counterMoreThan >= counterLessThan;
    }
            ...
            if (response.length() > 0) {
                ...
                case '6':
                    ...
                    System.out.println("odds = " + Math.round(odds[0] * TOTAL_RPS / ITER) + ":"
                            + Math.round(odds[1] * TOTAL_RPS / ITER) + ":" + Math.round(odds[2] * TOTAL_RPS / ITER));
                ...
                case 'h':
                    ...
                    System.out.println(
                            "averageTopTwo(" + Arrays.toString(scores2) + ") = " + exercise.averageTopTwo(scores2));
                    break;
                case 'I':
                case 'i':
                    ...
                    int j = 2;
                    System.out
                            .println("liesOnDiagonal(" + i + ", " + j + ") = " + exercise.liesOnDiagonal(matrix, i, j));
                    i = 0;
                    j = 1;
                    System.out
                            .println("liesOnDiagonal(" + i + ", " + j + ") = " + exercise.liesOnDiagonal(matrix, i, j));
