...
public class JMCh24Exercises {
    /**
     * Question 24-19
     * A class Date has methods int getMonth() that returns a value between 0 and 11
     * (with 0 representing January) and int getDate() returns the day of the month
     * represented by this Date object. The value returned is between 1 and 31
     * representing the day of the month that contains or begins with the instant in
     * time represented by this Date object, as interpreted in the local time zone.
     * Write the method
     * 
     * public boolean has3OnSameDay(Date[] birthdays)
     * 
     * that returns true if at least three birthdays in the array fall on the same
     * date. Your method should work in O(n) time, where n = birthdays.length.
     * 
     * @param birthdays
     ...
     * 
     * that returns the most frequently occurring word (or any one of such words).
     * Use a Map<String, Integer> to hold the counts for different words.
     * 
     * @param input The file you want to read
     * @return The most frequently occurring word (or any one of such words)
     */
    public String mostFrequentWord(Scanner input) {
