...
public class TeletextList {
    ...
    public TeletextList(String[] headlines) {
        // SYNTAX: ListNode2.ListNode2<String>
        // (String initValue, initPrevious, initNext)

        /**
         * Creates a circular list 
         * with 1 node called heading
         */
        heading = new ListNode2<String>("Today's headlines:", null, null);

        /**
         * Adds a node holding an empty string before 
         * heading and another node holding
        ...
        /**
         * Appends all the strings from headlines to the list, 
         * after the blank line that
    ...
    /**
     * Inserts a node with msg into the headlines 
     * list after the blank /line
    ...
    public void insert(String msg) {
        ...
        /**
         * Creates a new node called head2 using 
         * head.getNext(). head3 is also created
         */
    ...
    public void delete() {
        ...
        /**
         * Checks if that next value is the same 
         * as the heading or a blank line(blank
         * lines surround heading so you can 
         * use getNext and getPrevious here)
         */
        if (temp.equals(heading) || temp.equals(
            heading.getPrevious()) || temp.equals(heading.getNext())) {
            /**
        ...
        /**
         * Else, create a newNode that contains the 
         * value after temp. Set topNode to the
         * value 2 lines after heading. Replace 
         * the item in topNode with newNode, the
         * value after temp. Set the value before 
         * topNode to a blank line
         * 
         * Essentially, you just delete the node 
         * that follows topNode from the headlines
         * list.
         */
    ...
    public void scrollUp() {
        /**
         * Inbuilt function. You get the value 
         * after topNode, advancing it to the next
         * node
         */
    ...
    private ListNode2<String> addBefore(ListNode2<String> node, String msg) {
        /**
         * Create a newNode that contains 
         * {node.getPrevious(), msg, node}
         */
         ...
         * node.getPrevious and node to newNode
         */
    ...
    private ListNode2<String> addAfter(ListNode2<String> node, String msg) {
        ...
        /**
         * Set the value 2 nodes 
         * ahead of node to newNode
         */
    ...
    private void remove(ListNode2<String> node) {
        /**
         * Traverse the array until you 
         * reach node using a while loop
         */
        ...
        /**
         * Once you reach node, create a 
         * newNode that contains a blank space
         */
        ListNode2<String> newNode = heading.getNext().getNext();

        /**
         * Remove the node by 
         * overwriting it with newNode
         */
    ...
    /**
     * Draws nLines headlines in g, 
     * starting with topNode at x, y and
     * incrementing y by lineHeight 
     * after each headline.
     * 
     * @param g Graphics
     * @param x x
     * @param y y
     * @param lineHeight int value lineHeight
     * @param nLines int value nLines
     */
